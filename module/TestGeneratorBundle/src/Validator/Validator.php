...
namespace SoftDevNord\TestGenerator\Validator;

use SoftDevNord\TestGenerator\Exception\RuntimeCommandException;
...
final class Validator
{
    ...
    public static function entityExists(?string $className = null, array $entities = []): string
    {
        ...
        if (!in_array($className, $entities, true) && !in_array(ltrim($className, '\\'), $entities, true)) {
