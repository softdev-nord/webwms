...
use WebWMS\Bundles\BundleGeneratorBundle\Generator\BundleGenerator;

/**
 * @package:    WebWMS\Bundles\BundleGeneratorBundle\Command
 * @author:     SoftDev Nord, Rene Irrgang
 * @copyright:  Copyright © 2022, SoftDev Nord
 * Class        BaseGenerateBundleCommand
 */
#[AsCommand(
    name: 'webwms-generate-bundle',
    ...
    protected function configure()
    {
        $this
            ...
            ->setDefinition([
                ...
                new InputOption('dir', '', InputOption::VALUE_REQUIRED, 'The directory where to create the bundle', 'custom/plugins/'),
                new InputOption('bundle-name', '', InputOption::VALUE_REQUIRED, 'The optional bundle name'),
                new InputOption('format', '', InputOption::VALUE_REQUIRED, 'Use the format for configuration files (php, xml, yaml, or annotation)', 'yaml'),
    ...
    protected function interact(InputInterface $input, OutputInterface $output)
    {
        ...
        if ($askForBundleName) {
            ...
            $question->setValidator(
                ['WebWMS\Bundle\BundleGeneratorBundle\Command\Validators', 'validateBundleName']
            );
    ...
    protected function checkAutoloader(OutputInterface $output, Bundle $bundle)
    {
        ...
        if (!class_exists($bundle->getBundleClassName())) {
            return [
                ...
                sprintf('  <comment>"%s\\\\": "%s"</comment>', str_replace('\\', '\\\\', $bundle->getNamespace()), $bundle->getTargetDirectory()),
            ];
        }
    }

    protected function updateKernel(KernelInterface $kernel, Bundle $bundle): array
    {
