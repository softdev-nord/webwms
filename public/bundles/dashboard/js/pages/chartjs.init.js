$.ajax({
    ...
    success : function (data) {
        ...
        const customer_order_date = [];

        for (const i in data) {
            customer_order_id.push(data[i].customer_order_id);
            customer_order_date.push(data[i].customer_order_date);
        }
        ...
        function getChartColorsArray(r) {
            ...
            r.prototype.respChart = function(r, o, e, a) {
                ...
                r = {
                    labels: ["Januar", "Februar", "März", "April", "Mai", "Juni", "Juli", "August", "September", "October", "November", "Dezember"],
                    datasets: [{
                        ...
                        pointRadius: 1,
                        pointHitRadius: 10,
                        data: [customer_order_date.length]
                    }]
                };
                var r = (this.respChart(l("#lineChart"), "Line", r, {
                        scales: {
                            yAxes: [{
                                ticks: {
                                    max: 100,
                    ...
                    r = (this.respChart(l("#doughnut"), "Doughnut", r), getChartColorsArray("#pie")),
                    r = {
                        labels: ["Desktops", "Tablets"],
                        datasets: [{
                            data: [300, 180],
                    ...
                    r = (this.respChart(l("#pie"), "Pie", r), getChartColorsArray("#bar")),
                    r = {
                    ...
                    r = (this.respChart(l("#bar"), "Bar", r, {
                        scales: {
                            xAxes: [{
                                barPercentage: .4
                            }]
                        }
                    }), getChartColorsArray("#radar")),
                    r = {
        ...
        console.log('Got AJAX data count orders', customer_order_id.length);
    }
});