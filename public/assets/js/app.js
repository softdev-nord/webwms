...
//			document.getElementById("navbar-nav").setAttribute("data-simplebar", "");
	...
	/**
	 * Setzt die Einstellungen für das Layout zurück
	 */
	...
	/**
	 * Handelt das Abmelden von webWMS
	 */
	function logOff() {
		if (document.getElementById("webwms-log-off")) {
			document.getElementById("webwms-log-off").addEventListener("click", function () {
