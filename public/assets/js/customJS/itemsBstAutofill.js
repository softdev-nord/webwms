...
var itemsAddNewRow = (function(){
	...
	function formHtml() {
		...
		html += '<input type="hidden" data-type="bst_id" name="inputBstId[]" id="bst_id_'+rowcount+'" class="inputBstId2" autocomplete="off" value="'+bstId+'">';
		html += '</td>';
		html += '<td>';
		html += '<input type="text" data-type="bst_pos_menge" name="inputBstPosMenge[]" id="bst_pos_menge_'+rowcount+'" class="form-control autocomplete_items" autocomplete="off">';
		html += '</td>';
		html += '</tr>';
		rowcount++;
		return html;
