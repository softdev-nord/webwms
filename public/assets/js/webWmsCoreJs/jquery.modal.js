;(function ($, window) {
    ...
    $.modal = {
        ...
        open: function (content, options) {
                ...
                case 'ajax':
                    $.ajax(content, {
                        ...
                        success: function (result) {
                            ...
                            $.publish('plugin/webWmsModal/onOpenAjax', me);
                        }
                    });
            ...
            $.publish('plugin/webWmsModal/onOpen', [ me ]);
        ...
        close: function () {
            ...
            $.publish('plugin/webWmsModal/onClose', [ me ]);
        ...
        setTransition: function (css, duration, animation, callback) {
            ...
            $.publish('plugin/webWmsModal/onSetTransition', [ me, css, opts ]);
        },
        ...
        setTitle: function (title) {
            ...
            $.publish('plugin/webWmsModal/onSetTitle', [ me, title ]);
        },
        ...
        setContent: function (content) {
            ...
            $.publish('plugin/webWmsModal/onSetContent', [ me ]);
        },
        ...
        setWidth: function (width) {
            ...
            $.publish('plugin/webWmsModal/onSetWidth', [ me ]);
        },
        ...
        setHeight: function (height) {
            ...
            $.publish('plugin/webWmsModal/onSetHeight', [ me ]);
        },
        ...
        setMaxHeight: function (height) {
            ...
            $.publish('plugin/webWmsModal/onSetMaxHeight', [ me ]);
        },
        ...
        initModalBox: function () {
            ...
            $.publish('plugin/webWmsModal/onInit', [ me ]);
        },
        ...
        registerEvents: function () {
            ...
            $.publish('plugin/webWmsModal/onRegisterEvents', [ me ]);
        },
        ...
        onKeyDown: function (event) {
            ...
            $.publish('plugin/webWmsModal/onKeyDown', [ me, event, keyCode ]);
        },
        ...
        onWindowResize: function (event) {
            ...
            $.publish('plugin/webWmsModal/onWindowResize', [ me, event ]);
        },
        ...
        center: function () {
            ...
            $.publish('plugin/webWmsModal/onCenter', [ me ]);
        },
        ...
        onOverlayClose: function () {
            ...
            $.publish('plugin/webWmsModal/onOverlayClick', [ me ]);
        },
    ...
    $.plugin('webWmsModalBox', {
        ...
        init: function () {
            ...
            $.subscribe(me.getEventName('plugin/webWmsModal/onClose'), $.proxy(me.onClose, me));

            $.publish('plugin/webWmsModalBox/onRegisterEvents', [ me ]);
        },
        ...
        onClick: function (event) {
            ...
            $.publish('plugin/webWmsModalBox/onClick', [ me, event ]);
        },
        ...
        onClose: function () {
            ...
            $.publish('plugin/webWmsModalBox/onClose', [ me ]);
        },
        ...
        destroy: function () {
            ...
            $.unsubscribe(me.getEventName('plugin/webWmsModal/onClose'));
