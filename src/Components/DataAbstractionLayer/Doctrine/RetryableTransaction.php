...
class RetryableTransaction
{
     ...
     */
    public static function retryable(Connection $connection, \Closure $closure): mixed
    {
     ...
     * @return mixed
     */
    private static function retry(Connection $connection, \Closure $closure, int $counter): mixed
    {
        ++$counter;
