...
class EnvironmentHelper
{
     ...
     */
    public static function getVariable(string $key, $default = null): float|bool|int|string|null
    {
        $value = $_SERVER[$key] ?? $_ENV[$key] ?? null;
        $transformerData = new EnvironmentHelperTransformerData($value, $default);
