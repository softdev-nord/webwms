...
{
    public function __construct(private InventoryId $receiptId, private InventoryId $ledgerEntryId, private TenantId $tenantId, private InventoryId $locationId, private ReturnQualityDecision $decision, private string $note, private StockDimensions $dimensions, private UserId $inspectedBy, private DateTimeImmutable $inspectedAt)
    {
    ...
    public function decision(): ReturnQualityDecision { return $this->decision; }
