...
{
    public function __construct(private InventoryId $id, private TenantId $tenantId, private InventoryId $warehouseId, private string $code, private string $locationPrefix, private UserId $createdBy, private DateTimeImmutable $createdAt)
    {
