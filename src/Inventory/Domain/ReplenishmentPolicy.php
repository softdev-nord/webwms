...
{
    public function __construct(private InventoryId $id, private TenantId $tenantId, private InventoryId $warehouseId, private InventoryId $productId, private InventoryId $targetLocationId, private string $code, private string $sourceLocationPrefix, private int $minimumQuantity, private int $targetQuantity, private int $priority, private UserId $createdBy, private DateTimeImmutable $createdAt)
    {
    ...
    public function targetLocationId(): InventoryId { return $this->targetLocationId; }
    public function code(): string { return mb_strtoupper(trim($this->code)); }
    public function sourceLocationPrefix(): string { return $this->sourceLocationPrefix; }
    public function minimumQuantity(): int { return $this->minimumQuantity; }
    public function targetQuantity(): int { return $this->targetQuantity; }
