...
{
    public function __construct(private InventoryId $id, private TenantId $tenantId, private InventoryId $pickListId, private string $code, private UserId $createdBy, private DateTimeImmutable $createdAt)
    {
