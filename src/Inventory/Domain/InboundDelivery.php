...
final readonly class InboundDelivery
{
    ...
    public function __construct(private InventoryId $id, private TenantId $tenantId, private InventoryId $purchaseOrderId, private string $code, private string $deliveryNote, private DateTimeImmutable $expectedAt, private array $lines, private UserId $createdBy, private DateTimeImmutable $createdAt)
    {
    ...
    public function purchaseOrderId(): InventoryId { return $this->purchaseOrderId; }
    public function code(): string { return mb_strtoupper(trim($this->code)); }
    public function deliveryNote(): string { return trim($this->deliveryNote); }
    public function expectedAt(): DateTimeImmutable { return $this->expectedAt; }
