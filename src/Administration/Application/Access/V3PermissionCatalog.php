...
final class V3PermissionCatalog
{
    ...
    public const ALL = [
        ...
        'fulfillment.pick.control', 'fulfillment.pick.optimize', 'fulfillment.pick.wave.write',
        'fulfillment.transport.assign', 'fulfillment.transport.configure', 'fulfillment.transport.execute',
        'fulfillment.transport.read', 'fulfillment.transport.write',
        'fulfillment.replenishment.execute', 'fulfillment.replenishment.read', 'fulfillment.replenishment.write',
        ...
        'platform.extension.execute', 'platform.extension.read', 'platform.extension.write',
    ];
