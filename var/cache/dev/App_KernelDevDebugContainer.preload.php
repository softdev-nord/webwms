...
require __DIR__.'/ContainerB40ODG0/App_KernelDevDebugContainer.php';
require __DIR__.'/ContainerB40ODG0/getWebpackEncore_TagRendererService.php';
require __DIR__.'/ContainerB40ODG0/getWebpackEncore_ExceptionListenerService.php';
require __DIR__.'/ContainerB40ODG0/getWebpackEncore_EntrypointLookupCollectionService.php';
require __DIR__.'/ContainerB40ODG0/getWebpackEncore_EntrypointLookupDefaultService.php';
require __DIR__.'/ContainerB40ODG0/getWebProfiler_Controller_RouterService.php';
require __DIR__.'/ContainerB40ODG0/getWebProfiler_Controller_ProfilerService.php';
require __DIR__.'/ContainerB40ODG0/getWebProfiler_Controller_ExceptionPanelService.php';
require __DIR__.'/ContainerB40ODG0/getValidator_NotCompromisedPasswordService.php';
require __DIR__.'/ContainerB40ODG0/getValidator_ExpressionService.php';
require __DIR__.'/ContainerB40ODG0/getValidator_EmailService.php';
require __DIR__.'/ContainerB40ODG0/getTwig_Runtime_SecurityCsrfService.php';
require __DIR__.'/ContainerB40ODG0/getTwig_Runtime_HttpkernelService.php';
require __DIR__.'/ContainerB40ODG0/getTwig_Mailer_MessageListenerService.php';
require __DIR__.'/ContainerB40ODG0/getTwig_Form_RendererService.php';
require __DIR__.'/ContainerB40ODG0/getTranslation_Loader_YmlService.php';
require __DIR__.'/ContainerB40ODG0/getTranslation_Loader_XliffService.php';
require __DIR__.'/ContainerB40ODG0/getTranslation_Loader_ResService.php';
require __DIR__.'/ContainerB40ODG0/getTranslation_Loader_QtService.php';
require __DIR__.'/ContainerB40ODG0/getTranslation_Loader_PoService.php';
require __DIR__.'/ContainerB40ODG0/getTranslation_Loader_PhpService.php';
require __DIR__.'/ContainerB40ODG0/getTranslation_Loader_MoService.php';
require __DIR__.'/ContainerB40ODG0/getTranslation_Loader_JsonService.php';
require __DIR__.'/ContainerB40ODG0/getTranslation_Loader_IniService.php';
require __DIR__.'/ContainerB40ODG0/getTranslation_Loader_DatService.php';
require __DIR__.'/ContainerB40ODG0/getTranslation_Loader_CsvService.php';
require __DIR__.'/ContainerB40ODG0/getSession_Storage_NativeService.php';
require __DIR__.'/ContainerB40ODG0/getSessionService.php';
require __DIR__.'/ContainerB40ODG0/getServicesResetterService.php';
require __DIR__.'/ContainerB40ODG0/getSerializer_Mapping_CacheClassMetadataFactoryService.php';
require __DIR__.'/ContainerB40ODG0/getSerializerService.php';
require __DIR__.'/ContainerB40ODG0/getSecurity_Validator_UserPasswordService.php';
require __DIR__.'/ContainerB40ODG0/getSecurity_User_Provider_Concrete_AppUserProviderService.php';
require __DIR__.'/ContainerB40ODG0/getSecurity_PasswordEncoderService.php';
require __DIR__.'/ContainerB40ODG0/getSecurity_Logout_Listener_Default_MainService.php';
require __DIR__.'/ContainerB40ODG0/getSecurity_Logout_Listener_CsrfTokenClearingService.php';
require __DIR__.'/ContainerB40ODG0/getSecurity_HttpUtilsService.php';
require __DIR__.'/ContainerB40ODG0/getSecurity_Firewall_Map_Context_MainService.php';
require __DIR__.'/ContainerB40ODG0/getSecurity_Firewall_Map_Context_DevService.php';
require __DIR__.'/ContainerB40ODG0/getSecurity_EncoderFactory_GenericService.php';
require __DIR__.'/ContainerB40ODG0/getSecurity_Csrf_TokenStorageService.php';
require __DIR__.'/ContainerB40ODG0/getSecurity_Csrf_TokenManagerService.php';
require __DIR__.'/ContainerB40ODG0/getSecurity_ContextListener_0Service.php';
require __DIR__.'/ContainerB40ODG0/getSecurity_ChannelListenerService.php';
require __DIR__.'/ContainerB40ODG0/getSecurity_AuthenticationUtilsService.php';
require __DIR__.'/ContainerB40ODG0/getSecurity_Authentication_Provider_Guard_MainService.php';
require __DIR__.'/ContainerB40ODG0/getSecurity_Authentication_Provider_Dao_MainService.php';
require __DIR__.'/ContainerB40ODG0/getSecurity_Authentication_Listener_Guard_MainService.php';
require __DIR__.'/ContainerB40ODG0/getSecurity_Authentication_Listener_Form_MainService.php';
require __DIR__.'/ContainerB40ODG0/getSecurity_Authentication_Listener_Anonymous_MainService.php';
require __DIR__.'/ContainerB40ODG0/getSecurity_AccessMapService.php';
require __DIR__.'/ContainerB40ODG0/getSecurity_AccessListenerService.php';
require __DIR__.'/ContainerB40ODG0/getSecrets_VaultService.php';
require __DIR__.'/ContainerB40ODG0/getRouting_LoaderService.php';
require __DIR__.'/ContainerB40ODG0/getPropertyInfo_SerializerExtractorService.php';
require __DIR__.'/ContainerB40ODG0/getPropertyAccessorService.php';
require __DIR__.'/ContainerB40ODG0/getMonolog_Logger_SecurityService.php';
require __DIR__.'/ContainerB40ODG0/getMimeTypesService.php';
require __DIR__.'/ContainerB40ODG0/getFragment_Renderer_InlineService.php';
require __DIR__.'/ContainerB40ODG0/getForm_TypeGuesser_ValidatorService.php';
require __DIR__.'/ContainerB40ODG0/getForm_TypeGuesser_DoctrineService.php';
require __DIR__.'/ContainerB40ODG0/getForm_TypeExtension_Upload_ValidatorService.php';
require __DIR__.'/ContainerB40ODG0/getForm_TypeExtension_Form_ValidatorService.php';
require __DIR__.'/ContainerB40ODG0/getForm_TypeExtension_Form_TransformationFailureHandlingService.php';
require __DIR__.'/ContainerB40ODG0/getForm_TypeExtension_Form_HttpFoundationService.php';
require __DIR__.'/ContainerB40ODG0/getForm_TypeExtension_Form_DataCollectorService.php';
require __DIR__.'/ContainerB40ODG0/getForm_TypeExtension_CsrfService.php';
require __DIR__.'/ContainerB40ODG0/getForm_Type_FormService.php';
require __DIR__.'/ContainerB40ODG0/getForm_Type_FileService.php';
require __DIR__.'/ContainerB40ODG0/getForm_Type_EntityService.php';
require __DIR__.'/ContainerB40ODG0/getForm_Type_ColorService.php';
require __DIR__.'/ContainerB40ODG0/getForm_Type_ChoiceService.php';
require __DIR__.'/ContainerB40ODG0/getForm_ServerParamsService.php';
require __DIR__.'/ContainerB40ODG0/getForm_RegistryService.php';
require __DIR__.'/ContainerB40ODG0/getForm_FactoryService.php';
require __DIR__.'/ContainerB40ODG0/getForm_ChoiceListFactory_CachedService.php';
require __DIR__.'/ContainerB40ODG0/getFilesystemService.php';
require __DIR__.'/ContainerB40ODG0/getErrorHandler_ErrorRenderer_HtmlService.php';
require __DIR__.'/ContainerB40ODG0/getErrorControllerService.php';
require __DIR__.'/ContainerB40ODG0/getDoctrine_Orm_Validator_UniqueService.php';
require __DIR__.'/ContainerB40ODG0/getDoctrine_Orm_DefaultListeners_AttachEntityListenersService.php';
require __DIR__.'/ContainerB40ODG0/getDoctrine_Orm_DefaultEntityManager_PropertyInfoExtractorService.php';
require __DIR__.'/ContainerB40ODG0/getDebug_Security_Voter_VoteListenerService.php';
require __DIR__.'/ContainerB40ODG0/getDebug_Security_Voter_Security_Access_SimpleRoleVoterService.php';
require __DIR__.'/ContainerB40ODG0/getDebug_Security_Voter_Security_Access_ExpressionVoterService.php';
require __DIR__.'/ContainerB40ODG0/getDebug_Security_Voter_Security_Access_AuthenticatedVoterService.php';
require __DIR__.'/ContainerB40ODG0/getDebug_Security_UserValueResolverService.php';
require __DIR__.'/ContainerB40ODG0/getDebug_FileLinkFormatter_UrlFormatService.php';
require __DIR__.'/ContainerB40ODG0/getDebug_ArgumentResolver_VariadicService.php';
require __DIR__.'/ContainerB40ODG0/getDebug_ArgumentResolver_SessionService.php';
require __DIR__.'/ContainerB40ODG0/getDebug_ArgumentResolver_ServiceService.php';
require __DIR__.'/ContainerB40ODG0/getDebug_ArgumentResolver_RequestAttributeService.php';
require __DIR__.'/ContainerB40ODG0/getDebug_ArgumentResolver_RequestService.php';
require __DIR__.'/ContainerB40ODG0/getDebug_ArgumentResolver_NotTaggedControllerService.php';
require __DIR__.'/ContainerB40ODG0/getDebug_ArgumentResolver_DefaultService.php';
require __DIR__.'/ContainerB40ODG0/getContainer_GetenvService.php';
require __DIR__.'/ContainerB40ODG0/getContainer_EnvVarProcessorsLocatorService.php';
require __DIR__.'/ContainerB40ODG0/getContainer_EnvVarProcessorService.php';
require __DIR__.'/ContainerB40ODG0/getCacheClearerService.php';
require __DIR__.'/ContainerB40ODG0/getCache_SystemClearerService.php';
require __DIR__.'/ContainerB40ODG0/getCache_GlobalClearerService.php';
require __DIR__.'/ContainerB40ODG0/getCache_AppClearerService.php';
require __DIR__.'/ContainerB40ODG0/getAnnotations_CacheService.php';
require __DIR__.'/ContainerB40ODG0/getTemplateControllerService.php';
require __DIR__.'/ContainerB40ODG0/getRedirectControllerService.php';
require __DIR__.'/ContainerB40ODG0/getLoginFormAuthenticatorService.php';
require __DIR__.'/ContainerB40ODG0/getUserRepositoryService.php';
require __DIR__.'/ContainerB40ODG0/getUserTypeService.php';
require __DIR__.'/ContainerB40ODG0/getSecurityControllerService.php';
require __DIR__.'/ContainerB40ODG0/getRequirementsControllerService.php';
require __DIR__.'/ContainerB40ODG0/getHomepageControllerService.php';
require __DIR__.'/ContainerB40ODG0/get_ServiceLocator_XA8Fw_Service.php';
require __DIR__.'/ContainerB40ODG0/get_ServiceLocator_G9CqTPpService.php';
require __DIR__.'/ContainerB40ODG0/get_ServiceLocator_Beq5mCoService.php';
require __DIR__.'/ContainerB40ODG0/get_ServiceLocator_MuerpNPService.php';
require __DIR__.'/ContainerB40ODG0/get_ServiceLocator_C9JCBPCService.php';
...
$classes[] = 'App\Controller\RequirementsController';
