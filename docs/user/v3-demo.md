...
14. Unter **Administration** eine eingeschränkte Rolle und einen Benutzer mit E-Mail-Anmeldung anlegen.
15. Einen API-Client erzeugen und das nur einmal angezeigte Credential sicher kopieren.
