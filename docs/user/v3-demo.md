...
13. Unter **Administration** eine eingeschränkte Rolle und einen Benutzer mit E-Mail-Anmeldung anlegen.
14. Einen API-Client erzeugen und das nur einmal angezeigte Credential sicher kopieren.
