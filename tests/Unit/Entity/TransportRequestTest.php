...
final class TransportRequestTest extends TestCase
{
    ...
    public function testGettersAndSetters(): void
    {
        ...
        self::assertSame($id, $this->transportRequest->getId());
        ...
        self::assertSame($articleNr, $this->transportRequest->getArticleNr());

        // Test setTrQuantity() and getTrQuantity()
        $trQuantity = 80.000;
        $this->transportRequest->setTrQuantity($trQuantity);
        self::assertSame($trQuantity, $this->transportRequest->getTrQuantity());
        ...
        self::assertSame($trType, $this->transportRequest->getTrType());
